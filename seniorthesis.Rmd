...
```{r calculate pi_ij, and pi_.i vectorize}
ij_count = matrix(0, nrow=2, ncol=2)
get_ij = function(){
ij_count[1,1] = dim(data[(data[,1]==1 & data[,3]==1)|(data[,1]==1&is.na(data[,3])),])
ij_count[1,2] = dim(data[(data[,1]==1 & data[,5]==1)|(data[,1]==1&is.na(data[,5])),])
ij_count[2,1] = dim(data[(data[,2]==1 & data[,4]==1)|(data[,2]==1&is.na(data[,4])),])
ij_count[2,2] = dim(data[(data[,2]==1 & data[,6]==1)|(data[,2]==1&is.na(data[,6])),])
return (ij_count)
}
system.time(get_ij)
```
