...
n = dim(data)[1]
ij_count = get_ij(data=data, cond= 1)
notij_count = get_ij(data=data, cond= 0)
i_count = get_i(data=data)
yj_count = get_j(data=data, cols=c(5,6), cond=1, j=2)
yj_count = get_j(data=data, cols=c(3,4), cond=1, j=1, j_count=yj_count1)
notj_count = get_j(data=data, cols=c(5,6), cond=0, j=2)
notj_count = get_j(data=data, cols=c(3,4), cond=0, j=1, j_count=notj_count1)
pi1_i. = i_count / n
# the grand total proportion of yeses and nos for the ith, jth and ijth values
yp1_.j = yj_count / n
np1_.j = notj_count / n
ypi1_ij = ij_count / n
npi1_ij = notij_count / n
...
ij_count1 = get_ij(data=data.star, cond= 1)
notij_count1 = get_ij(data=data.star, cond= 0)
i_count1 = get_i(data=data.star)
yj_count1 = get_j(data=data.star, cols=c(5,6), cond=1, j=2)
yj_count1 = get_j(data=data.star, cols=c(3,4), cond=1, j=1, j_count=yj_count1)
notj_count1 = get_j(data=data.star, cols=c(5,6), cond=0, j=2)
notj_count1 = get_j(data=data.star, cols=c(3,4), cond=0, j=1, j_count=notj_count1)
pi_i. = i_count1 / n
# the grand total proportion of yeses and nos for the ith, jth and ijth values
yp_.j = yj_count1 / n
np_.j = notj_count1 / n
